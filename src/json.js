...
console.error('File fixing error:', err);
}
};
...
if(path === "ervel.json" && path !== undefined) throw new Error('path must be not same as default. If you want to use default you do not have to identify.')
