...
if (typeof mongodbURL !== "string") throw new Error(`MongodbURL must be string, ${typeof mongodbURL}`);
if (connectionOptions && typeof connectionOptions !== "object") throw new Error(`Expected Object for connectionOptions, ${typeof connectionOptions}`);
